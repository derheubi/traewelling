<div class="card status mt-3" id="status-{{ $status->id }}" data-body="{{ $status->body }}" data-private="{{ $status->private }}" data-date="{{formatNewDay(new \DateTime($status->trainCheckin->departure)) }}">
